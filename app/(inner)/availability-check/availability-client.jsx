...
export default function PostcodeGatePageClient() {
  ...
  const checkAvailability = async () => {
    ...
    if (typeof window !== "undefined" && window.gtag) {
      window.gtag("event", "postcode_gate_checked", {
    ...
    setTimeout(() => {
      if (inArea) {
        ...
        if (typeof window !== "undefined" && window.gtag) {
          window.gtag("event", "postcode_gate_blocked", {
            event_category: "Availability Checker",
  ...
  const handleLeadSubmit = async (e) => {
    ...
    if (typeof window !== "undefined" && window.gtag) {
      window.gtag("event", "postcode_gate_lead_submit", {
        event_category: "Availability Checker",
                  ...
                  <div key="input" className="space-y-3 sm:space-y-4">
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                      <input
                        ...
                        className="flex-1 px-4 sm:px-5 py-3 sm:py-4 rounded-xl bg-white border-2 border-[#e5e7eb] text-[#1D1D1D] placeholder:text-[#85929D] outline-none focus:ring-2 focus:ring-[#214B57]/15 focus:border-[#214B57] transition text-base sm:text-lg font-dm-sans"
                        onKeyPress={(e) => {
                          if (e.key === "Enter") {
                            checkAvailability();
                          }
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-sm sm:text-base font-normal font-dm-sans shadow-[0_18px_45px_rgba(26,29,41,0.08)] hover:bg-[#214B57] transition-all duration-150 active:bg-white active:text-[#F04E22] active:border-2 active:border-[#F04E22] disabled:bg-[#CED3D7] disabled:text-[#85929D] disabled:cursor-not-allowed whitespace-nowrap"
                ...
                {status === "soft-gate" && !leadSaved && (
                  <div key="soft-gate" className="py-8">
                    ...
                    <form onSubmit={handleLeadSubmit} className="space-y-4 max-w-md mx-auto">
                      ...
                      <button
                        type="submit"
                        className="w-full min-w-[122px] min-h-[31px] py-2 rounded-md text-white font-normal font-dm-sans shadow-[0_18px_45px_rgba(26,29,41,0.08)] hover:bg-[#214B57] transition-all duration-150 active:bg-white active:text-[#F04E22] active:border-2 active:border-[#F04E22]"
                        style={{ backgroundColor: '#F04E22' }}
                      >
          ...
          <FadeIn direction="left" delay={0.2} duration={0.6}>
            <div className="space-y-6">
              ...
              <div className="rounded-2xl p-6 text-white" style={{ backgroundColor: '#214B57' }}>
                ...
                <a
                  href="/contact-us"
                  className="inline-flex items-center gap-2 min-w-[122px] min-h-[31px] px-5 py-2 rounded-md bg-white text-[#214B57] font-normal font-dm-sans text-sm hover:bg-[#F04E22] hover:text-white transition-all duration-150 active:bg-white active:text-[#F04E22] active:border-2 active:border-[#F04E22]"
                >
                  Contact Support
        ...
        <FadeIn direction="up" delay={0.3} duration={0.6}>
          <div className="bg-[#f9fafb] border border-[#e5e7eb] rounded-2xl p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="font-semibold text-[#214B57] mb-4 font-noto-serif" style={{ fontSize: 'clamp(1.75rem, 3vw, 2.5rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <span className="text-[#F04E22] font-bold mt-1">✓</span>
