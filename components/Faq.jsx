                  ...
                  <FadeIn key={index} className="bg-transparent">
                    ...
                    >
                      <div className="min-w-0">
                        <p className="text-[#214B57] font-noto-serif" style={{ fontSize: 'clamp(1rem, 1.75vw, 1.625rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                          {faq.question}
                        </p>
                        <p className="mt-1 text-[#85929D] font-dm-sans" style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
                        ...
                        >
                          <div className="px-5 sm:px-7 pb-6">
                            <motion.div
                              ...
                              className="rounded-2xl border border-black/10 bg-white/70 backdrop-blur p-5 text-[#85929D] font-dm-sans"
                            ...
                            >
                              {["Premium finishing", "Transparent scope", "Professional execution"].map((tag, tagIdx) => (
                                <span
                                  key={tag}
                                  className="px-3 py-1 rounded-full bg-black/5 border border-black/10 text-xs font-semibold text-[#214B57] font-dm-sans"
                                >
                                  {tag}
                                </span>
                              ))}
