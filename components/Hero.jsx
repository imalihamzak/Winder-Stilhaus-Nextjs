    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm" suppressHydrationWarning>
        <div className={containerClass}>
          ...
          {/* Top Nav */}
          <div
            className="flex items-center justify-between text-sm font-medium text-[#85929D] py-3 sm:py-4"
              ...
              {heroContent.navLinks.map((link) => {
                ...
                return (
                  <a
                    ...
                    className={`
                      relative transition
                      ${active ? "text-[#214B57] font-semibold" : "text-[#85929D] hover:text-[#214B57]"}
                  ...
                  return (
                    <a
                      ...
                      className={`text-sm font-semibold transition ${
                        active ? "text-[#214B57] font-bold" : "text-[#85929D] hover:text-[#214B57]"
                      }`}
                    >
                      {link.label}
                    </a>
                ...
                <div className="pt-2">
                  <a
                    ...
                    className="
                      ...
                      bg-[#F04E22] text-white text-sm font-normal font-dm-sans
      ...
      <section
        ...
        suppressHydrationWarning
      >
        {/* ✅ Monogram placed like reference: cropped from RIGHT + BOTTOM */}
        <motion.div
          aria-hidden="true"
          className="absolute inset-0 hidden lg:block z-0 pointer-events-none select-none overflow-hidden"
          initial={{ opacity: 0, scale: 0.98 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.8, delay: 0.35, ease: [0.22, 1, 0.36, 1] }}
        >
          {/* Monogram viewport area */}
          <div className="absolute inset-y-0 right-0 w-[min(62vw,980px)] overflow-hidden">
            <Image
              src="/assets/Icon-4K.png"
              alt=""
              fill
              priority
              className="
        ...
        <div className={`${containerClass} relative z-10`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              >
                <span
                  className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#f9fafb] border border-[#e5e7eb] text-[11px] uppercase tracking-[0.32em] text-[#1D1D1D] font-dm-sans"
                  style={{
              ...
              <motion.h1
                className="typography-headline text-[#214B57]"
                style={{
              ...
              <motion.p
                className="text-[#85929D] max-w-xl text-base sm:text-lg leading-relaxed font-dm-sans"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <a
                  ...
                  onClick={(e) => {
                    if (heroContent.primaryCta.href.startsWith("#")) {
                      ...
                      if (target) {
                        ...
                        setTimeout(() => {
                          const heading =
                            target.querySelector("#pricing-guide-heading") ||
                  ...
                  className="group inline-flex items-center justify-center gap-2 min-w-[122px] min-h-[31px] px-6 py-2 rounded-md text-white text-sm font-normal font-dm-sans hover:bg-[#214B57] transition-all duration-150 focus:outline-none focus:ring-3 focus:ring-[#214B57] focus:ring-offset-2 active:bg-white active:text-[#F04E22] active:border-2 active:border-[#F04E22] disabled:bg-[#CED3D7] disabled:text-[#85929D] disabled:cursor-not-allowed"
                  style={{ backgroundColor: "#F04E22" }}
                >
