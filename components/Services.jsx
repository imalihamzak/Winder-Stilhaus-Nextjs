...
export default function Services() {
  ...
  const [stride, setStride] = useState(360); // card width + gap
        ...
        >
          ...
          <button
            ...
            className={`
              ...
              shadow-[0_12px_30px_rgba(26,29,41,0.05)]
              flex items-center justify-center transition
              ${canPrev ? "hover:bg-black/[0.03]" : "opacity-35 cursor-not-allowed"}
            `}
          >
            <ChevronLeft className="text-[#214B57]" size={16} />
          </button>
          ...
          <button
            ...
            className={`
              ...
              shadow-[0_12px_30px_rgba(26,29,41,0.05)]
              flex items-center justify-center transition
              ${canNext ? "hover:bg-black/[0.03]" : "opacity-35 cursor-not-allowed"}
            `}
          >
            <ChevronRight className="text-[#214B57]" size={16} />
          </button>
              ...
              return (
                <div
                  ...
                  className="
                    ...
                    border border-black/10 bg-white
                    shadow-[0_18px_45px_rgba(26,29,41,0.03)]
                    p-4 sm:p-5 md:p-6
                  "
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="w-11 h-11 rounded-full border border-black/10 bg-black/[0.03] flex items-center justify-center text-[#214B57]">
                      <Icon className="w-5 h-5" />
                    </div>

                    <span className="text-[11px] uppercase tracking-[0.28em] text-[#85929D] font-dm-sans">
                      Service
                    </span>
                  </div>

                  <h3 className="mt-4 text-[#214B57] font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2.17rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                    {s.title}
                  </h3>

                  <p className="mt-2 text-[#85929D] font-dm-sans" style={{ fontSize: 'clamp(0.875rem, 1.5vw, 1.5rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
                    {s.description}
                  </p>
              ...
              {Array.from({ length: maxIndex + 1 }).map((_, i) => (
                <button
                  ...
                  className={`
                    ...
                    ${i === index ? "w-7 bg-[#214B57]" : "w-2.5 bg-black/20 hover:bg-black/30"}
                  `}
