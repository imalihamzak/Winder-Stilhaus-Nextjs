...
export default function Testimonials() {
  ...
  return (
    <section className="bg-white text-[#101423] px-3 sm:px-4 md:px-6 py-14 md:py-18 relative overflow-hidden select-none">
      <div className="max-w-7xl mx-auto relative">
        {/* Premium background accents (subtle, consistent with your global bg) */}
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -left-16 top-10 h-72 w-72 rounded-full bg-[#c49a41]/10 blur-3xl" />
          <div className="absolute -right-16 bottom-0 h-72 w-72 rounded-full bg-[#1a1d29]/10 blur-3xl" />
        </div>
        ...
        <FadeIn className="relative text-center mb-10 md:mb-12 px-2">
          ...
          <h2 className="mt-4 text-[#214B57] font-noto-serif max-w-2xl mx-auto" style={{ fontSize: 'clamp(2.5rem, 4vw, 4.17rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[30px] border border-black/10 bg-white/55 backdrop-blur shadow-[0_30px_90px_rgba(15,22,36,0.05)]">
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between">
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          <p className="text-xs uppercase tracking-[0.28em] text-[#85929D] font-dm-sans">
                            {current.location}
                          </p>
                          <p className="text-sm text-[#85929D] mt-1 font-dm-sans">
                            {current.property}
                          </p>
                        </div>

                        <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/5 border border-black/10 text-xs font-semibold text-[#214B57] font-dm-sans">
                      ...
                      <div className="mt-6">
                        <div className="inline-flex items-center gap-3 mb-4">
                          <div className="w-11 h-11 rounded-full bg-[#1a1d29] text-white flex items-center justify-center text-xl font-bold shadow-[0_14px_35px_rgba(26,29,41,0.09)]">
                            &quot;
                          </div>
                      ...
                      <div className="mt-7 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
                        <div>
                          <p className="text-[#214B57] font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2.17rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                            {current.name}
                          </p>
                          <div className="mt-2 flex items-center gap-3">
                            <Stars rating={current.rating} />
                            <span className="text-sm text-[#85929D] font-dm-sans">
                              4.9/5 average
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          <span className="px-3 py-1 rounded-full bg-white/70 border border-black/10 text-sm font-semibold text-[#214B57] font-dm-sans">
                            On-time delivery
                          </span>
                          <span className="px-3 py-1 rounded-full bg-[#214B57] text-white text-sm font-semibold shadow-[0_14px_35px_rgba(33,75,87,0.07)] font-dm-sans">
                            Premium finish
                          </span>
                        </div>
                      </div>
                      ...
                      {/* Satisfaction bar */}
                      <div className="mt-6">
                        <div className="flex items-center justify-between text-sm text-[#85929D] font-dm-sans">
                    ...
                    <div className="relative">
                      ...
                      <div className="relative overflow-hidden rounded-[20px] sm:rounded-[24px] border border-black/10 bg-white/60 shadow-[0_25px_70px_rgba(15,22,36,0.06)] h-[240px] sm:h-[280px] md:h-[340px] lg:h-full min-h-[240px] sm:min-h-[320px]">
                        <img
                          src={current.image}
                      ...
                      {/* Floating badge */}
                      <div className="absolute -bottom-5 left-6 rounded-full bg-white/90 backdrop-blur border border-black/10 px-4 py-2 shadow-[0_18px_45px_rgba(33,75,87,0.05)] text-sm font-semibold text-[#214B57] flex items-center gap-2 font-dm-sans">
              ...
              <button
                ...
                className="hidden md:flex absolute right-4 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-[#214B57] text-white items-center justify-center shadow-[0_18px_45px_rgba(33,75,87,0.08)] hover:opacity-90 transition"
              >
                →
              </button>
            </div>
            ...
            <div className="mt-7 flex flex-col items-center gap-4">
                ...
                {testimonials.map((_, i) => (
                  <button
                    ...
                    className={`h-2.5 rounded-full cursor-pointer transition-all ${
                      i === index ? "w-9 bg-[#214B57]" : "w-2.5 bg-black/15"
                    }`}
                  />
                ))}
              </div>
              ...
              <div className="flex md:hidden justify-center gap-3">
                <button
                  onClick={prevSlide}
                  className="px-6 py-2 rounded-md border border-black/10 bg-white/80 text-[#1a1d29] font-normal font-dm-sans shadow-[0_12px_30px_rgba(26,29,41,0.04)] hover:bg-white transition min-w-[122px] min-h-[31px]"
                >
                  ← Prev
                </button>
                <button
                  onClick={nextSlide}
                  className="px-6 py-2 rounded-md min-w-[122px] min-h-[31px] bg-[#F04E22] text-white font-normal font-dm-sans hover:bg-[#214B57] transition-all duration-150 active:bg-white active:text-[#F04E22] active:border-2 active:border-[#F04E22]"
              ...
              <p className="text-xs text-[#6c6f7a]">
                Swipe on mobile • Auto-rotates every few seconds
              </p>
            </div>
          </div>
        </FadeIn>
