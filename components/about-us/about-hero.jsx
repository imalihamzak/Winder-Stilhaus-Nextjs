...
export default function AboutHero() {
  return (
    <section className="relative bg-white pt-0 pb-12 sm:pb-16 md:pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        <FadeIn direction="up" delay={0.2} duration={0.6}>
          <div className="text-center mb-3">
            ...
            <p className="text-[#85929D] max-w-3xl mx-auto mb-8 font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.5vw, 1.5rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
        ...
        <FadeIn direction="up" delay={0.4} duration={0.6}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div
                key={i}
                className="text-center p-4 rounded-2xl border border-[#e5e7eb] bg-white/60 backdrop-blur"
              >
                <div
                  className="text-3xl sm:text-4xl font-bold text-[#214B57] mb-1 font-noto-serif"
                >
                  {stat.value}
                </div>
                <p className="text-xs sm:text-sm text-[#85929D] font-medium font-dm-sans" style={{ fontSize: 'clamp(0.75rem, 1vw, 0.875rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
                  {stat.label}
                </p>
              </div>
            ))}
