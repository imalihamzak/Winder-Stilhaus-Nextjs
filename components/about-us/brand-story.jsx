...
import { Award, Lightbulb, Handshake, Rocket } from "lucide-react";

export default function BrandStory() {
  return (
    <section className="bg-white pt-0 pb-8 sm:pb-10 md:pb-12">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-8">
          ...
          <FadeIn direction="left" delay={0.4} duration={0.6}>
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-[#214B57] mb-4 font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2.17rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                  Our Journey
                </h3>
                <div className="space-y-4 text-[#85929D] font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.5vw, 1.5rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
                  <p>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                {[
                  ...
                  return (
                    <div
                      key={i}
                      className="p-4 rounded-2xl border border-[#e5e7eb] bg-white/60 backdrop-blur"
                    >
                      <Icon className="text-[#214B57] mb-2 text-xl" />
                      <div className="text-2xl font-bold text-[#214B57] font-noto-serif">{item.value}</div>
                      <div className="text-xs text-[#85929D] mt-1 font-dm-sans">{item.label}</div>
                    </div>
                  );
                })}
              </div>
        ...
        <FadeIn direction="up" delay={0.5} duration={0.6}>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="relative overflow-hidden rounded-[28px] border border-[#e5e7eb] bg-white/60 backdrop-blur p-8 sm:p-10">
              ...
              <h3 className="font-semibold text-[#214B57] mb-4 font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2.17rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>Our Mission</h3>
            ...
            <div className="relative overflow-hidden rounded-[28px] border border-[#e5e7eb] bg-white/60 backdrop-blur p-8 sm:p-10">
              ...
              <h3 className="font-semibold text-[#214B57] mb-4 font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2.17rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>Our Vision</h3>
              <p className="text-[#85929D] font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.5vw, 1.5rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
