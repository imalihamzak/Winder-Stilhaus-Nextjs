...
import { Shield, Wrench, PhoneCall, CheckCircle, Clock, Handshake } from "lucide-react";
    ...
    <>
      ...
      <section className="bg-white py-6 md:py-8 px-3 sm:px-4 md:px-6">
        ...
        <FadeIn className="mb-12" duration={0.6} delay={0.4}>
          <h2 className="font-semibold text-[#214B57] mb-8 text-center font-noto-serif" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2.17rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
            Aftercare Process
          </h2>
        ...
        <FadeIn duration={0.6} delay={0.5}>
          <div className="rounded-[30px] border border-black/10 text-white shadow-lg p-8 sm:p-10 text-center" style={{ backgroundColor: '#214B57' }}>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="/contact-us"
                className="inline-flex items-center gap-2 min-w-[122px] min-h-[31px] px-8 py-2 rounded-md bg-white text-[#214B57] font-normal font-dm-sans shadow-lg hover:bg-[#F04E22] hover:text-white transition-all duration-150 active:bg-white active:text-[#F04E22] active:border-2 active:border-[#F04E22]"
              >
