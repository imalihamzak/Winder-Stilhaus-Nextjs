  ...
  if (submitted) {
    return (
      <div className="text-center py-8">
        ...
        <h3 className="text-2xl font-semibold font-noto-serif text-[#214B57] mb-2">
          Thank you!
        </h3>
        <p className="text-[#85929D] font-dm-sans">
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-6">
        <div className="flex flex-col gap-2">
          <label htmlFor="name" className="text-sm font-semibold text-[#214B57] font-dm-sans">
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="email" className="text-sm font-semibold text-[#214B57] font-dm-sans">
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="phone" className="text-sm font-semibold text-[#214B57] font-dm-sans">
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="city" className="text-sm font-semibold text-[#214B57] font-dm-sans">
      ...
      <button
        ...
        className="
          ...
          min-w-[122px] min-h-[31px] px-10 py-2 rounded-md text-white font-normal font-dm-sans hover:bg-[#214B57] transition-all duration-150 active:bg-white active:text-[#F04E22] active:border-2 active:border-[#F04E22]
        "
      ...
      <p className="mt-3 text-xs text-[#85929D] font-dm-sans">
