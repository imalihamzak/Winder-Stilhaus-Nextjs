    ...
    <section className="bg-white pt-0 pb-16 sm:pb-20 md:pb-24">
      <div className={containerClass}>
        ...
        <FadeIn direction="up" delay={0.1} duration={0.6} className="mb-10 md:mb-12">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5">
            <div className="max-w-2xl">
              ...
              <h2 className="text-[#214B57] font-noto-serif mb-4" style={{ fontSize: 'clamp(2.5rem, 4vw, 4.17rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                Resource Hub
              </h2>
        ...
        <FadeIn direction="up" delay={0.15} duration={0.6}>
          <div className="flex flex-wrap gap-2 sm:gap-3 mb-8 sm:mb-12 pb-4 sm:pb-6 border-b border-[#e5e7eb]">
                ...
                className={`px-4 sm:px-5 py-1.5 sm:py-2 rounded-full border text-xs sm:text-sm font-medium transition
                  ${
                    selectedCategory === category
                      ? "bg-[#214B57] text-white border-[#214B57] shadow-sm font-dm-sans"
                      : "border-[#e5e7eb] text-[#85929D] hover:bg-[#f9fafb] hover:border-[#214B57]/30 font-dm-sans"
                  }`}
              >
                {category}
              </button>
        ...
        <FadeIn direction="up" delay={0.2} duration={0.6}>
          <article className="group relative overflow-hidden rounded-[24px] sm:rounded-[30px] border border-[#e5e7eb] bg-white shadow-lg mb-8 sm:mb-12">
            <div className="relative">
              <div className="relative h-[240px] sm:h-[280px] md:h-[380px] overflow-hidden">
                ...
                <div className="absolute left-3 sm:left-5 right-3 sm:right-5 bottom-3 sm:bottom-5 flex items-end justify-between gap-2 sm:gap-3">
                  <span className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full bg-white/95 border border-[#e5e7eb] text-[10px] sm:text-xs font-semibold text-[#214B57] shadow-sm font-dm-sans">
              ...
              <div className="p-4 sm:p-6 md:p-8">
                <div className="flex items-center justify-between text-xs text-[#85929D] mb-4 font-dm-sans">
                  <span className="font-semibold text-[#214B57]">
                    By {featured.author}
                  </span>
                  <span>{featured.date}</span>
                </div>

                <h3 className="text-[#214B57] font-noto-serif leading-[1.2] mb-4" style={{ fontSize: 'clamp(1.75rem, 3vw, 3.5rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                  {featured.title}
                </h3>
                ...
                <div className="flex items-center justify-between">
                  <a
                    ...
                    className="inline-flex items-center gap-2 min-w-[122px] min-h-[31px] px-6 py-2 rounded-md text-white font-normal font-dm-sans hover:bg-[#214B57] transition-all duration-150"
                    style={{ backgroundColor: '#F04E22' }}
                  >
                    Read guide <span className="text-lg">→</span>
                  </a>

                  <span className="hidden sm:inline-flex px-3 py-1 rounded-full bg-[#f9fafb] border border-[#e5e7eb] text-sm font-semibold text-[#214B57] font-dm-sans">
                    Featured
                  </span>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {filteredBlogs.map((blog, index) => (
            <FadeIn
              ...
              duration={0.6}
            >
              <article className="group relative overflow-hidden rounded-[24px] border border-[#e5e7eb] bg-white shadow-sm hover:shadow-lg transition-shadow">
                <div className="relative">
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/95 border border-[#e5e7eb] text-xs font-semibold text-[#214B57] shadow-sm font-dm-sans">
                  ...
                  <div className="p-5 sm:p-6">
                    <div className="flex items-center justify-between text-xs text-[#85929D] mb-3 font-dm-sans">
                      <span className="font-semibold text-[#214B57]">
                        {blog.author}
                      </span>
                    ...
                    <h3 className="text-[#214B57] font-noto-serif leading-[1.2] mb-3 line-clamp-2" style={{ fontSize: 'clamp(1.25rem, 2vw, 1.75rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                      {blog.title}
                    </h3>

                    <p className="text-[#85929D] line-clamp-3 mb-4 font-dm-sans" style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
                      {blog.desc}
                    </p>

                    <div className="flex items-center justify-between pt-4 border-t border-[#e5e7eb]">
                      <span className="text-xs text-[#85929D] font-dm-sans">{blog.date}</span>
                      <a
        ...
        <FadeIn direction="up" delay={0.4} duration={0.6}>
          <div className="mt-12 rounded-[30px] border border-[#e5e7eb] bg-[#214B57] text-white shadow-lg p-8 sm:p-10">
            <p className="text-xs uppercase tracking-[0.28em] text-white/70 mb-2 font-dm-sans">
              Want a personalized plan?
            </p>
            <p className="font-noto-serif leading-[1.2] mb-6" style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2.17rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
              Get design guidance for your exact space and budget.
            </p>
            <a
              href="/contact-us"
              className="inline-flex items-center gap-2 min-w-[122px] min-h-[31px] px-8 py-2 rounded-md bg-white text-[#214B57] font-normal font-dm-sans shadow-lg hover:bg-[#F04E22] hover:text-white transition-all duration-150"
            >
