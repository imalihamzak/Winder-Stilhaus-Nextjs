    ...
    <section className="bg-white text-[#1D1D1D] px-3 sm:px-4 md:px-6 py-14 md:py-18 relative overflow-hidden select-none">
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -left-16 top-10 h-72 w-72 rounded-full bg-[#F06434]/10 blur-3xl" />
        ...
        <FadeIn className="relative text-center mb-10 md:mb-12 px-2" duration={0.6}>
          ...
          <h2 className="mt-4 text-[#214B57] font-noto-serif" style={{ fontSize: 'clamp(2rem, 3.6vw, 3.2rem)', fontWeight: 600, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
