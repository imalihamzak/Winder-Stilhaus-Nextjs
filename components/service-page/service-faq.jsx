    ...
    <section className="bg-white py-6 md:py-8 px-3 sm:px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="rounded-[28px] border border-black/10 bg-white/45 backdrop-blur shadow-[0_30px_90px_rgba(15,22,36,0.04)] overflow-hidden">
            <div className="divide-y divide-black/10">
              ...
              <button
                      ...
                      className="w-full text-left px-5 sm:px-7 py-5 flex items-center justify-between gap-4 hover:bg-white/40 transition"
              >
                      <div className="min-w-0">
                        <p className="font-semibold text-[#214B57] font-noto-serif" style={{ fontSize: 'clamp(1rem, 1.75vw, 1.625rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif' }}>
                {faq.question}
                        </p>
                      </div>
                      <span
                        className={`shrink-0 w-10 h-10 rounded-full border border-black/10 bg-white/70 flex items-center justify-center shadow-[0_12px_30px_rgba(26,29,41,0.04)] transition-transform ${isOpen ? 'rotate-180' : ''}`}
                      >
                    ...
                    {isOpen && (
                        ...
                        >
                          <div className="px-5 sm:px-7 pb-6">
                            <div className="rounded-2xl border border-black/10 bg-white/70 backdrop-blur p-5 text-[#85929D] font-dm-sans shadow-[0_18px_45px_rgba(26,29,41,0.03)]" style={{ fontSize: 'clamp(0.875rem, 1.5vw, 1.5rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif' }}>
                  {faq.answer}
                </div>
                          </div>
                        </div>
