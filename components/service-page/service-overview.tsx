...
export default function ServiceOverview({ service }: ServiceOverviewProps) {
  ...
  return (
    <section className="bg-[#1D1D1D] pt-3 sm:pt-4 md:pt-5 pb-6 md:py-8 px-3 sm:px-4 md:px-6 border-t border-[#4A4A4A]">
      <div className="max-w-7xl mx-auto">
        <FadeIn className="mb-6 md:mb-8" duration={0.6}>
          ...
          <h2 className="text-white font-noto-serif text-center" style={{ fontSize: 'clamp(2rem, 3.6vw, 3.2rem)', fontWeight: 600, lineHeight: '1.5', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#FFFFFF' }}>
            Service Overview
          </h2>
        </FadeIn>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          {service.overview?.map((text, i) => (
              <p key={i} className="text-white/90 font-dm-sans" style={{ fontSize: 'clamp(1rem, 1.5vw, 1.5rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'DM Sans, sans-serif', color: 'rgba(255, 255, 255, 0.9)' }}>
              {text}
            </p>
          ))}
          </FadeIn>
          ...
          <FadeIn direction="left">
            <div className="rounded-[24px] border border-[#4A4A4A] bg-white shadow-[0_18px_45px_rgba(0,0,0,0.1)] p-6 sm:p-8">
              <h3 className="font-semibold text-[#1D1D1D] mb-5 font-noto-serif" style={{ fontSize: 'clamp(1.25rem, 2vw, 1.75rem)', fontWeight: 400, lineHeight: '1.2', letterSpacing: '0px', fontFamily: 'Noto Serif, serif', color: '#1D1D1D' }}>
            Key Benefits
          </h3>
