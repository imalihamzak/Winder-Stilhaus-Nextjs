...
export default function WhatsIncluded({ service }) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {service.includes.map((item, i) => (
            ...
            >
              <div
                className="flex items-center gap-3 rounded-[20px] border border-black/10 bg-white/60 backdrop-blur shadow-[0_12px_30px_rgba(26,29,41,0.03)] p-5"
            >
